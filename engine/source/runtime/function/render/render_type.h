...
namespace Movan
{
    enum class MOVAN_IMAGE_TYPE : uint8_t
    {
        MOVAN_IMAGE_TYPE_UNKNOWM = 0,
        MOVAN_IMAGE_TYPE_2D
    };
    ...
    public:
        ...
        MOVAN_IMAGE_TYPE   m_type { MOVAN_IMAGE_TYPE::MOVAN_IMAGE_TYPE_UNKNOWM};
...
template<>
struct std::hash<Movan::MeshSourceDesc>
{
    size_t operator()(const Movan::MeshSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};
template<>
struct std::hash<Movan::MaterialSourceDesc>
{
    size_t operator()(const Movan::MaterialSourceDesc& rhs) const noexcept { return rhs.getHashValue(); }
};
