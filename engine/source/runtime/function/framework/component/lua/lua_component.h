...
namespace Movan
{
    ...
    public:
        ...
        template<typename T>
        static void set(std::weak_ptr<SceneObject> game_object, const char* name, T value);

        template<typename T>
        static T get(std::weak_ptr<SceneObject> game_object, const char* name);

        static void invoke(std::weak_ptr<SceneObject> game_object, const char* name);
    protected:
